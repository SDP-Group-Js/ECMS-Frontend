        ...
        {institutionWorkflows.map((workflow) => (
          <div className='text-left w-1/3 py-2 pl-2'>
            <button
              ...
              className='w-full hover:bg-gray-700 hover:text-white hover:font-bold p-2 flex justify-between items-center border-2 rounded-lg'
            >
        ...
        <Modal onClick={() => setSelectedWorkflow(null)}>
          ...
          >
            <button
              ...
              className='bg-red-700 text-white rounded-full p-1 w-fit h-fit absolute top-4 right-4'
            >
